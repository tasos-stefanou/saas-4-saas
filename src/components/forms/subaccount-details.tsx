...
//TODO: layout.tsx only runs once as a result if you remove permissions for someone and they keep navigating the layout.tsx wont fire again. solution- save the data inside metadata for current user.
...
const SubAccountDetails: React.FC<SubAccountDetailsProps> = ({
  ...
  const form = useForm<SubAccountDetailsFormType>({
  ...
  async function onSubmit(values: SubAccountDetailsFormType) {
    try {
